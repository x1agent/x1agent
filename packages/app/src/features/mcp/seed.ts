...
export const MCP_SEED: readonly McpSeedEntry[] = [
  ...
  },
  {
    ...
    description: "CRM accounts, contacts, opportunities, custom objects.",
  ...
  },
  {
    ...
    description: "Support tickets, conversations, knowledge base.",
    simple_icon: "zendesk",
  ...
  },
  {
    ...
    description: "Incidents, on-call schedules, alert routing.",
    simple_icon: "pagerduty",
    homepage: "https://www.pagerduty.com/",
    kind: "remote_oauth",
    mcp_url: null,
    tags: ["incidents", "on-call", "observability"],
  },
  {
    slug: "datadog",
    display_name: "Datadog",
    description: "Metrics, logs, traces, monitors, dashboards.",
    simple_icon: "datadog",
    homepage: "https://www.datadoghq.com/",
    kind: "remote_oauth",
    mcp_url: null,
    tags: ["observability", "monitoring", "metrics", "logs"],
  },
  {
    slug: "vercel",
    display_name: "Vercel",
    description: "Deployments, projects, environment variables, logs.",
    simple_icon: "vercel",
    homepage: "https://vercel.com/",
    kind: "remote_oauth",
    mcp_url: null,
    tags: ["deployments", "hosting", "edge"],
  },
  {
    slug: "supabase",
  ...
  },
  {
    slug: "plaid",
    display_name: "Plaid",
    description: "Bank-account linking, transactions, balances across institutions.",
    simple_icon: "plaid",
  ...
  },
  {
    ...
    description: "Storefronts, products, orders, customers.",
    simple_icon: "shopify",
    homepage: "https://www.shopify.com/",
    kind: "remote_oauth",
    mcp_url: null,
    tags: ["commerce", "ecommerce", "orders"],
  },
  {
    slug: "posthog",
  ...
  },
  {
    slug: "figma",
    display_name: "Figma",
    description: "Design files, Dev Mode metadata, components, design tokens.",
    simple_icon: "figma",
    homepage: "https://www.figma.com/",
    kind: "remote_oauth",
    mcp_url: null,
    tags: ["design", "ui", "design-to-code"],
  },
  {
    slug: "discord",
    display_name: "Discord",
    description: "Servers, channels, messages, threads.",
    simple_icon: "discord",
    homepage: "https://discord.com/",
    kind: "remote_oauth",
    mcp_url: null,
    tags: ["messaging", "community", "chat"],
  },
  {
    // slug must start with a letter (catalog name regex); simple_icon
    // keeps the brand-correct "1password" CDN slug.
    slug: "onepassword",
    display_name: "1Password",
    description: "Vault items, secrets, credentials. Read scoped per item.",
    simple_icon: "1password",
  ...
  // ── Stdio coding tools (vendor-published, npm) ──────────────────────
  {
    slug: "chrome-devtools",
    display_name: "Chrome DevTools",
    description:
      "Drive a real Chrome — navigate, take snapshots, inspect console + network, take screenshots, run scripts. Google's official MCP.",
    simple_icon: "googlechrome",
    homepage: "https://github.com/ChromeDevTools/chrome-devtools-mcp",
    kind: "command",
    command: "npx",
    args: ["-y", "chrome-devtools-mcp@latest"],
    tags: ["browser", "debugging", "e2e", "devtools", "coding"],
  },
  {
    slug: "playwright",
    display_name: "Playwright",
    description:
      "Browser automation with Microsoft's Playwright runtime — multi-engine (Chromium, Firefox, WebKit), good for cross-browser e2e.",
    homepage: "https://github.com/microsoft/playwright-mcp",
    kind: "command",
    command: "npx",
    args: ["-y", "@playwright/mcp@latest"],
    tags: ["browser", "e2e", "testing", "coding"],
  },
  {
    slug: "context7",
    display_name: "Context7",
    description:
      "Up-to-date documentation lookup for libraries the agent is coding against. Useful when the model's training cutoff misses recent API changes.",
    simple_icon: "upstash",
    homepage: "https://github.com/upstash/context7",
    kind: "command",
    command: "npx",
    args: ["-y", "@upstash/context7-mcp@latest"],
    tags: ["docs", "coding", "reference"],
  },
