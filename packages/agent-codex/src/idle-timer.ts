// TODO(codex-spike): duplicated verbatim from packages/agent/src/idle-timer.ts
// for v0. Extract into packages/agent-runtime-base/ alongside the rest of the
// runtime-agnostic harness scaffolding in the follow-up to this spike.
/**
