...
After `mise run install:apply`, every workspace gets a "Token usage — this month" card visible to admins on the workspace home page. It shows:
...
Re-run `mise run install:apply`. This:
